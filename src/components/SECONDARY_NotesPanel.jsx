  ...
  return (
    <div className="h-full flex flex-col bg-white">
      ...
      {/* Header with Dark Purple Shader Look */}
       <div className="border-b border-indigo-900/20 p-4 bg-gradient-to-r from-slate-900 via-indigo-950 to-blue-950 shadow-lg">
         <div className="flex items-center justify-between">
           <div>
           ...
           <div className="flex items-center gap-3">
             {saveStatus && (
               <div className="text-xs px-2 py-1 bg-white/10 text-indigo-200 backdrop-blur-md border border-white/10 rounded-lg animate-fade-in">
                 {saveStatus}
               </div>
             )}
             <button
               onClick={handleExportNotes}
               className="px-3 py-2 text-sm bg-white/5 border border-white/10 text-indigo-100 rounded-lg hover:bg-white/10 transition-all active:scale-95 flex items-center gap-2 backdrop-blur-sm"
               title="Download notes as text file"
             >
             ...
             <button
               onClick={handleSaveToServer}
               disabled={isSaving}
               className="px-4 py-2 text-sm bg-indigo-600 text-white rounded-lg hover:bg-indigo-500 hover:shadow-[0_0_15px_rgba(99,102,241,0.4)] transition-all disabled:opacity-50 disabled:cursor-not-allowed font-semibold flex items-center gap-2"
             >
               {isSaving ? (
                 <>
